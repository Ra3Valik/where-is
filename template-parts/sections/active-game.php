...
$title = $get_field( 'active_game_title' );
$preview_icon = $get_field( 'active_game_preview_icon' );
$preview_text = nl2br( $get_field( 'active_game_preview_text' ) );
$button_text = $get_field( 'active_game_button_text' );

$no_game_title = $get_field( 'active_game_no_game_title' );
$no_game_subtitle = nl2br( $get_field( 'active_game_no_game_subtitle' ) );
$archive_link_text = $get_field( 'active_game_archive_link_text' );
$archive_link_url = $get_field( 'active_game_archive_link_url' );
?>
